...
DEFAULT = odict((
    ...
    ("WINDOW",
        odict((
            ...
            ("timer_font_size",
                (32,
                 "The size of the timer font in pixels",
                 None, None)),
            ("header",
                (74,
            ...
            ("input_login_bg",
                ((28,28,31),
                 "The color of the Login input box background (list of tuples)",
                 None, None)),
            ("font_primary_color",
                ((255,255,255),
                 "The color of the primary font (list of tuples)",
                 None, None)),
            ("font_secondary_color",
                ((0,0,0),
                 "The color of the secondary font (list of tuples)",
                 None, None)),
            ("app_bg_primary",
                ((33,33,35),
                 "The primary color of the program background (list of tuples)",
                 None, None)),
            ("app_bg_secondary",
                ((36,36,38),
                 "The secondary color of the program background (list of tuples)",
                 None, None)),
            ("th_bg",
                ((101,101,103),
            ...
            ("btn_primary_radius",
                ((24,24,24,24),
                 "The radius of the primary program bbuttons (TL, TR, BL, BR - list of tuples)",
                 None, None)),
            ("btn_secondary_radius",
                ((24,24,24,24),
                 "The radius of the secondary program bbuttons (TL, TR, BL, BR - list of tuples)",
                 None, None)),
            ("btn_num_radius",
                ((8,8,8,8),
