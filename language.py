...
DEFAULT = {
    'en': {        
        ...
        'choose_staff': "Choose Correctional Staff",
        'no_staff': "No Staff",
        'No_documents': "No Documents",
        'decrypt': "Enter Decryption Key",
        'wrong_decrypt': "Wrong Decryption Key, redirecting",
        'locked': "Too many attempts: Locked for 30 seconds",
        'intro' : " ",
        '1': "1 photo",
        #'2': "2 photos",
        #'3': "3 photos",
        ...
        'print_forget': "Please Take a photo",
        ...
        'no_orders':"No documents have been found",
        'download_orders':"Please refresh documents",
        'downloading':"Refreshing Documents",
        'no_camera':"Camera not detected",
        'capture_again': "Approve Photo?",
        'done':"Return to Documents",
        'num_of_pages': "Number of pages",
        'finished': "Your confirmation receipt has been sent to your legal counsel",
        'oops': "Something went wrong",
        'wrong_password':"Incorrect Facility Code",
        'wrong_co':"Incorrect CO Code, waiting to redirect",
        'Q1':" ",
