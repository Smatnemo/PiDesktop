...
from LDS.utils import LOGGER, load_module
from LDS.plugins import hookspecs
from LDS.plugins.camera_plugin import CameraPlugin
from LDS.plugins.lights_plugin import LightsPlugin
from LDS.plugins.picture_plugin import PicturePlugin
from LDS.plugins.printer_plugin import PrinterPlugin
from LDS.plugins.view_plugin import ViewPlugin



def create_plugin_manager():
    # Create plugin manager and define hook specifications
